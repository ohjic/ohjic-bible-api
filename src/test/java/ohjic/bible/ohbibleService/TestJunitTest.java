           ...
           /* length >=3 => 책 장 절 검사 , length ==2 => 책 장 검사 , 그외 검색 불능*/
            if(splitValue.length >=3){
                ...
                if(!(chapter.equals("") || paragraph.equals(""))){
                    ...
                    bibleSerchVO = new BibleSerchVO(1,bookName,Integer.parseInt(chapter),Integer.parseInt(firstParagraphTest),Integer.parseInt(lastParagraphTest),searchRange);
                }else{
                ...
                chapter = splitValue[1].replaceAll(regExp,"");
                searchRange = "chapter";
                bibleSerchVO = new BibleSerchVO(1,bookName,Integer.parseInt(chapter),searchRange);
            }else{
                System.out.println("can not Search");
            }
